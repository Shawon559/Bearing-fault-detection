"""Train improved 3-class model on Paderborn dataset."""
import json
...
from dataset_paderborn_3class_windowed import Paderborn3ClassWindowedDataset, create_balanced_loader, create_loader
from model_paderborn_3class import create_model_3class
...
def train_paderborn_3class_improved(
    data_root: str = "../../data",
    checkpoint_dir: str = "checkpoints_3class_improved",
    output_dir: str = "outputs_3class_improved",
    ...
    """Train improved 3-class model on Paderborn."""
    ...
    print("\n" + "="*70)
    print("IMPROVED 3-CLASS SUPERVISED PADERBORN TRAINING")
    print("="*70)
    print("\nImprovements:")
    ...
    print(f"Actual Healthy   {cm[0,0]:3d}     {cm[0,1]:3d}    {cm[0,2]:3d}")
    print(f"       Inner     {cm[1,0]:3d}     {cm[1,1]:3d}    {cm[1,2]:3d}")
    print(f"       Outer     {cm[2,0]:3d}     {cm[2,1]:3d}    {cm[2,2]:3d}")
    ...
    print(f"Baseline (non-overlapping): 91.67%")
    print(f"Improvement: {test_acc - 91.67:.2f}%")
    print("="*70)
    ...
    with open(f"{output_dir}/paderborn_3class_improved_history.json", 'w') as f:
        json.dump(history, f, indent=2)

    print(f"\nOK Results saved to {output_dir}/paderborn_3class_improved_history.json")
    print("="*70)
...
if __name__ == "__main__":
    ...
    test_acc = train_paderborn_3class_improved(
        data_root=str(paderborn_data),
        checkpoint_dir="checkpoints_3class_improved",
        output_dir="outputs_3class_improved",
    ...
    print(f"\nFinal 3-Class Improved Test Accuracy: {test_acc:.2f}%")
